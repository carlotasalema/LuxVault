...
Item.create!(
  ...
  user_id: users.sample.id,
  photo: 'https://media.gucci.com/style/DarkGray_Center_0_0_490x490/1713456007/443497_AADPJ_6207_002_065_0015_Light-GG-Marmont-small-shoulder-bag.jpg'
)
...
Item.create!(
  ...
  user_id: users.sample.id,
  photo: 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw9a24df85/images/large/d06a4d0a48175370a6c0706e8ee15088.png?sw=750&sh=750&sm=fit&sfrm=png'
)
